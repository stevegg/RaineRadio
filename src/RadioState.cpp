...
{
   Serial.println("RadioState::RadioState()");
 ...
 */
void RadioState::addTransition(bool (*conditionFunction)(), RadioState *s)
{
 ...
 */
void RadioState::addTransition(bool (*conditionFunction)(), int stateNumber)
{
 ...
 */
int RadioState::evalTransitions()
{
 ...
 */
int RadioState::setTransition(int index, int stateNo)
{
   if (transitions->size() == 0)
      return -1;
